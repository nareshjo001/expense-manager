...
# Only ValueError (stratification infeasible, e.g. a class with fewer than 2 members) falls back to a non-stratified split; any other exception propagates.
...
try:
    ...
    print(f"STRATIFY FAILED ({e}) — USING NORMAL SPLIT\n")
